...
var EditableGrid = function (props) {
    ...
    var _c = __read(React.useState(false), 2), isOpenForAdd = _c[0], setIsOpenForAdd = _c[1];
    var dismissPanelForAdd = React.useCallback(function () { return setIsOpenForAdd(false); }, []);
    var _d = __read(useState([]), 2), gridData = _d[0], setGridData = _d[1];
    var _e = __read(useState([]), 2), defaultGridData = _e[0], setDefaultGridData = _e[1];
    var _f = __read(useState([]), 2), backupDefaultGridData = _f[0], setBackupDefaultGridData = _f[1];
    var _g = __read(useState([]), 2), activateCellEdit = _g[0], setActivateCellEdit = _g[1];
    var _h = __read(useState(''), 2), selectionDetails = _h[0], setSelectionDetails = _h[1];
    var _j = __read(useState(), 2), selectedItems = _j[0], setSelectedItems = _j[1];
    var _k = __read(useState([]), 2), cancellableRows = _k[0], setCancellableRows = _k[1];
    var _l = __read(useState(0), 2), selectionCount = _l[0], setSelectionCount = _l[1];
    var _m = __read(useState([]), 2), selectedIndices = _m[0], setSelectedIndices = _m[1];
    var _o = __read(React.useState(false), 2), isGridInEdit = _o[0], setIsGridInEdit = _o[1];
    var _p = __read(React.useState(undefined), 2), dialogContent = _p[0], setDialogContent = _p[1];
    var _q = __read(React.useState(undefined), 2), announced = _q[0], setAnnounced = _q[1];
    var _r = __read(React.useState(false), 2), isUpdateColumnClicked = _r[0], setIsUpdateColumnClicked = _r[1];
    var _s = __read(React.useState(false), 2), isColumnFilterClicked = _s[0], setIsColumnFilterClicked = _s[1];
    var _t = __read(useState(false), 2), showSpinner = _t[0], setShowSpinner = _t[1];
    var _u = __read(useState(false), 2), isGridStateEdited = _u[0], setIsGridStateEdited = _u[1];
    var _v = __read(useState(false), 2), isGridFilterEnabled = _v[0], setIsGridFilterEnabled = _v[1];
    var _w = __read(useState([]), 2), defaultTag = _w[0], setDefaultTag = _w[1];
    var _x = __read(useState([]), 2), filteredColumns = _x[0], setFilteredColumns = _x[1];
    var _y = __read(useState([]), 2), filterStore = _y[0], setFilterStore = _y[1];
    var gridColumnFilterArrRef = React.useRef([]);
    var _z = __read(React.useState(undefined), 2), filterCalloutComponent = _z[0], setFilterCalloutComponent = _z[1];
    var _0 = __read(React.useState(false), 2), showFilterCallout = _0[0], setShowFilterCallout = _0[1];
    var _1 = __read(React.useState({
        visible: false,
        message: '',
        subMessage: ''
    }), 2), messageDialogProps = _1[0], setMessageDialogProps = _1[1];
    var _2 = __read(React.useState({ key: '', isAscending: false, isEnabled: false }), 2), sortColObj = _2[0], setSortColObj = _2[1];
    ...
    var CheckBulkUpdateOnChangeCallBack = function (data, defaultGridDataTmp) {
        var columns = [];
        for (var key in data) {
            var column = props.columns.filter(function (item) { return item.key == key; })[0];
            if (column.onChange) {
                columns.push(column);
            }
        }
                                    ...
                                    ?
                                        (((_a = column === null || column === void 0 ? void 0 : column.hoverComponentOptions) === null || _a === void 0 ? void 0 : _a.enable) ?
                                            (_jsx(HoverCard, __assign({ type: HoverCardType.plain, plainCardProps: {
                                                ...
                                                }, instantOpenOnClick: true }, { children: RenderMultilineTextFieldSpan(props, index, rowNum, column, item, EditCellValue) })))
                                            :
                            ...
                            return _jsx("span", { children: (ShouldRenderSpan())
                                    ?
                                        (((_b = column === null || column === void 0 ? void 0 : column.hoverComponentOptions) === null || _b === void 0 ? void 0 : _b.enable) ?
                                            (_jsx(HoverCard, __assign({ type: HoverCardType.plain, plainCardProps: {
                                                    onRenderPlainCard: function () { return onRenderPlainCard(column, rowNum, item); },
                                                }, instantOpenOnClick: true }, { children: RenderDateSpan(props, index, rowNum, column, item, EditCellValue) })))
                                            :
                            ...
                            return _jsx("span", __assign({ className: 'row-' + rowNum + '-col-' + index }, { children: (ShouldRenderSpan())
                                    ?
                                        (((_c = column === null || column === void 0 ? void 0 : column.hoverComponentOptions) === null || _c === void 0 ? void 0 : _c.enable) ?
                                            (_jsx(HoverCard, __assign({ type: HoverCardType.plain, plainCardProps: {
                                                    onRenderPlainCard: function () { return onRenderPlainCard(column, rowNum, item); },
                                                }, instantOpenOnClick: true }, { children: RenderDropdownSpan(props, index, rowNum, column, item, EditCellValue) })))
                                            :
                            ...
                            return _jsx("span", { children: (ShouldRenderSpan())
                                    ?
                                        (((_r = column === null || column === void 0 ? void 0 : column.hoverComponentOptions) === null || _r === void 0 ? void 0 : _r.enable) ?
                                            (_jsx(HoverCard, __assign({ type: HoverCardType.plain, plainCardProps: {
                                                    onRenderPlainCard: function () { return onRenderPlainCard(column, rowNum, item); },
                                                }, instantOpenOnClick: true }, { children: RenderTextFieldSpan(props, index, rowNum, column, item, EditCellValue) })))
                                            :
        ...
        if (props.enableRowEdit) {
            columnConfigs.push({
                ...
                onRender: function (item, index) { return (_jsx("div", { children: (activateCellEdit && activateCellEdit[Number(item['_grid_row_id_'])] && activateCellEdit[Number(item['_grid_row_id_'])]['isActivated'])
                        ?
                            _jsxs("div", { children: [_jsx(IconButton, { disabled: editMode, onClick: function () { return ShowRowEditMode(item, Number(item['_grid_row_id_']), false); }, iconProps: { iconName: 'Save' }, title: 'Save' }), props.enableRowEditCancel
                                        ?
                                            _jsx(IconButton, { disabled: editMode, onClick: function () { return CancelRowEditMode(item, Number(item['_grid_row_id_'])); }, iconProps: { iconName: 'RemoveFilter' }, title: 'Cancel' })
                                        :
                                            null] })
                        :
                            _jsxs("div", { children: [!props.enableDefaultEditMode &&
                                        _jsx(IconButton, { onClick: function () { return ShowRowEditMode(item, Number(item['_grid_row_id_']), true); }, iconProps: { iconName: 'Edit' }, title: 'Edit' }), props.gridCopyOptions && props.gridCopyOptions.enableRowCopy &&
                                        _jsx(IconButton, { onClick: function () { return HandleRowCopy(Number(item['_grid_row_id_'])); }, iconProps: { iconName: "Copy" }, title: "Copy" })] }) })); },
            });
        }
    ...
    var RenderLinkSpan = function (props, index, rowNum, column, item, EditCellValue) {
        var _a, _b, _c, _d;
        return _jsx("span", __assign({ id: "id-".concat(props.id, "-col-").concat(index, "-row-").concat(rowNum), className: GetDynamicSpanStyles(column, item[column.key]), onClick: HandleCellOnClick(props, column, EditCellValue, rowNum), onDoubleClick: HandleCellOnDoubleClick(props, column, EditCellValue, rowNum) }, { children: ((_a = column.linkOptions) === null || _a === void 0 ? void 0 : _a.onClick)
                ?
                ...
                :
                    _jsx(Link, __assign({ target: "_blank", disabled: (_c = column.linkOptions) === null || _c === void 0 ? void 0 : _c.disabled, underline: true, href: (_d = column.linkOptions) === null || _d === void 0 ? void 0 : _d.href }, { children: item[column.key] })) }));
    };
    var RenderTextFieldSpan = function (props, index, rowNum, column, item, EditCellValue) {
        return RenderSpan(props, index, rowNum, column, item, HandleCellOnClick, EditCellValue, HandleCellOnDoubleClick);
    };
    var RenderPickerSpan = function (props, index, rowNum, column, item, EditCellValue) {
        return RenderSpan(props, index, rowNum, column, item, HandleCellOnClick, EditCellValue, HandleCellOnDoubleClick);
    };
    var RenderDropdownSpan = function (props, index, rowNum, column, item, EditCellValue) {
        return RenderSpan(props, index, rowNum, column, item, HandleCellOnClick, EditCellValue, HandleCellOnDoubleClick);
    };
    var RenderDateSpan = function (props, index, rowNum, column, item, EditCellValue) {
        return _jsx("span", __assign({ id: "id-".concat(props.id, "-col-").concat(index, "-row-").concat(rowNum), className: GetDynamicSpanStyles(column, item[column.key]), onClick: HandleCellOnClick(props, column, EditCellValue, rowNum), onDoubleClick: HandleCellOnDoubleClick(props, column, EditCellValue, rowNum) }, { children: item && item[column.key] ? (new Date(item[column.key])).toDateString() : null }));
    };
    var RenderMultilineTextFieldSpan = function (props, index, rowNum, column, item, EditCellValue) {
        return RenderSpan(props, index, rowNum, column, item, HandleCellOnClick, EditCellValue, HandleCellOnDoubleClick);
    };
    var RenderSpan = function (props, index, rowNum, column, item, HandleCellOnClick, EditCellValue, HandleCellOnDoubleClick) {
        return _jsx("span", __assign({ id: "id-".concat(props.id, "-col-").concat(index, "-row-").concat(rowNum), className: GetDynamicSpanStyles(column, item[column.key]), onClick: HandleCellOnClick(props, column, EditCellValue, rowNum), onDoubleClick: HandleCellOnDoubleClick(props, column, EditCellValue, rowNum) }, { children: item[column.key] }));
    };
    /* #endregion */
    /* #region [Utilities] */
    ...
    return (_jsxs(ThemeProvider, { children: [_jsx(Panel, __assign({ isOpen: isOpenForEdit, onDismiss: dismissPanelForEdit, isLightDismiss: true, headerText: "Edit Grid Data", closeButtonAriaLabel: "Close", type: PanelType.smallFixedFar }, { children: _jsx(EditPanel, { onChange: onEditPanelChange, columnConfigurationData: props.columns }) })), props.enableRowAddWithValues && props.enableRowAddWithValues.enable
                ...
                :
                    null, showFilterCallout && filterCalloutComponent, _jsx("div", __assign({ className: mergeStyles({ height: props.height != null ? props.height : '70vh', width: props.width != null ? props.width : '130vh', position: 'relative', backgroundColor: 'white', }) }, { children: _jsx(ScrollablePane, __assign({ scrollbarVisibility: ScrollbarVisibility.auto }, { children: _jsx(MarqueeSelection, __assign({ selection: _selection }, { children: _jsx(DetailsList, { compact: props.compact, items: defaultGridData.length > 0 ? defaultGridData.filter(function (x) { return (x._grid_row_operation_ != Operation.Delete) && (x._is_filtered_in_ == true) && (x._is_filtered_in_grid_search_ == true) && (x._is_filtered_in_column_filter_ == true); }) : [], columns: GridColumns, selectionMode: props.selectionMode, 
                ...
                _jsx(ColumnUpdateDialog, { columnConfigurationData: props.columns, onDialogCancel: CloseColumnUpdateDialog, onDialogSave: UpdateGridColumnData })
                :
