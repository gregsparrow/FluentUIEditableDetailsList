...
import { DatePicker, Dropdown, Position, PrimaryButton, SpinButton, Stack, TextField } from "@fluentui/react";
        ...
        props.columnConfigurationData.forEach(function (item, index) {
            ...
            switch (item.inputType) {
                ...
                case EditControlType.DropDown:
                    tmpRenderObj.push(_jsx(Dropdown, { label: item.text, options: (_a = item.dropdownValues) !== null && _a !== void 0 ? _a : [], onChange: function (ev, selected) { return onDropDownChange(ev, selected, item); } }));
                    break;
