...
var ColumnFilterDialog = function (props) {
            ...
            if (column.length > 0) {
                ...
                switch (column[0].dataType) {
                    case 'number':
                        ...
                        setOperatorDropDownContent(_jsx(Dropdown, { placeholder: "Select the Column", options: createCompareOptions(), styles: dropdownStyles, onChange: onSelectOperator }));
                        break;
                    case 'string':
                        setInputFieldContent(_jsx(TextField, { className: controlClass.textFieldClass, placeholder: "Value", onChange: function (ev, text) { return onTextUpdate(ev, text); }, styles: textFieldStyles }));
                        setOperatorDropDownContent(_jsx(Dropdown, { placeholder: "Select the Column", options: createCompareOptions(), styles: dropdownStyles, onChange: onSelectOperator }));
    ...
    var _e = __read(React.useState(_jsx(Dropdown, { placeholder: "Select the Column", options: createCompareOptions(), styles: dropdownStyles, onChange: onSelectValue })), 2), operatorDropDownContent = _e[0], setOperatorDropDownContent = _e[1];
